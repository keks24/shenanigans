...
cpu_temp_path=/sys/class/thermal/thermal_zone0
uptime_path=/proc
hostname=`hostname`
TIMEOUT=1
...
do
	...
	cpu_temp=`cat $cpu_temp_path/temp`
	...
	if (( $cpu_temp <= 49 ))
	then
		echo -e "\e[01;37mCurrent:\e[0m \t \e[01;32m$cpu_temp °C\e[0m"

	elif (( $cpu_temp >= 50 && $cpu_temp <= 59 ))
	then
		echo -e "\e[01;37mCurrent:\e[0m \t \e[01;33m$cpu_temp °C\e[0m"

	else
		echo -e "\e[01;37mCurrent:\e[0m \t \e[01;31m$cpu_temp °C\e[0m"
	fi
